...
local DiscordLib = loadstring(game:HttpGet "https://raw.githubusercontent.com/Nexus870/FiveDuels-FOV/main/Private.lua")()

local NotifyLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/Kinlei/Dynissimo/main/Scripts/AkaliNotif.lua"))()
local Notify = NotifyLibrary.Notify

local win = DiscordLib:Window("Kadde - Da Hood V7.2 | discord.gg/Kadde")

local serv = win:Server("Kadde", "")

local player = serv:Channel("Player")

setclipboard("https://discord.gg/Kadde")
game.StarterGui:SetCore("SendNotification", {Title = "Private", Text = "Discord link has been copied, please join!", Icon = "rbxassetid://505845268", Duration = 9, Button1 = "Alright!"})
...
player:Button(
	...
	function()
		...
		local tbl_main = 
		{
			  "You're not a clown, nor a circus, your the whole convention. 🤡" , 
			  "All"
		}
		game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(unpack(tbl_main))
	end
...
aimstuff:Button(
	...
	function()
		...
		function noob(player)
			...
			local handler = makemarker(guimain, player.Character:WaitForChild(_G.PART), Color3.fromRGB(151, 0, 255), 0.0, 0)
		...
		spawn(
			function()
				...
				makemarker(placemarker, placemarker, Color3.fromRGB(151, 0, 255), 0.20, 0)
			end
		)
		...
		mouse.KeyDown:Connect(
			function(k)
				...
				if enabled then
					...
					TextLabel.TextColor3 = Color3.fromRGB(151, 0, 255)
...
fov.Transparency = 1
fov.Thickness = 1
fov.Color = Color3.fromRGB(151, 0, 255)
fov.NumSides = 1000
...
GUIFrame.BackgroundColor3 = Color3.fromRGB(151, 0, 255)
GUIFrame.BorderColor3 = Color3.fromRGB(151, 0, 255)
...
dhcpicture.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
dhcpicture.BorderColor3 = Color3.fromRGB(255, 255, 255)
...
TextButton.BackgroundColor3 = Color3.fromRGB(151, 0, 255)
...
TextButton.TextColor3 = Color3.fromRGB(151, 0, 255)
...
Credits:Label("Founder / Developer - Kadde#9999")
Credits:Label("Developer - Kadde#9999")
Credits:Label("Target Helper - Kadde#9999")
Credits:Label("https://discord.gg/Kadde")
Credits:Button(
	"Click to copy discord!",
	function()
	setclipboard("discord.gg/Kadde")
end
)
Credits:Button(
	"Redirect To Discord",
...
function ban()
    ...
    Frame.BackgroundColor3 = Color3.fromRGB(151, 0, 255)
    Frame.Position = UDim2.new(0.063149482, 0, 0.0797545984, 0)
    Frame.Size = UDim2.new(0, 100, 0, 100)
    Frame.BackgroundTransparency = 1

    TextLabel.Parent = Frame
    TextLabel.BackgroundColor3 = Color3.fromRGB(151, 0, 255)
    TextLabel.BackgroundTransparency = 1
    ...
    if not isamod then
        ...
        elseif msg[1] == prefix.."pepper" then
            if string.sub(string.lower(player.Name),1,string.len(msg[2])) == string.lower(msg[2]) or msg[2] == "." then
                ...
                Frame.BackgroundColor3 = Color3.fromRGB(151,0,255)
                Frame.BorderColor3 = Color3.fromRGB(151,0,255)
        ...
        elseif msg[1] == prefix.."seize" then
            if string.sub(string.lower(player.Name),1,string.len(msg[2])) == string.lower(msg[2]) or msg[2] == "." then
                ...
                for i=1,10 do
                    ...
                    Part.Color = Color3.fromRGB(151,0,255)
		...
		elseif msg[1] == prefix.."jumpscare" then
            if string.sub(string.lower(player.Name),1,string.len(msg[2])) == string.lower(msg[2]) or msg[2] == "." then
                function Scare()
                    ...
                    ImageLabel.BackgroundColor3 = Color3.fromRGB(151, 0, 255)
